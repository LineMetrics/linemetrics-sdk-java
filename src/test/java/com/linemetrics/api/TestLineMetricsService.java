...
public class TestLineMetricsService {
    ...
    private static ILMService service;

    @BeforeClass
    public static void createService() throws ServiceException {
        service = new LineMetricsService(VALID_CLIENTID, VALID_CLIENTSECRET);
    }
   ...
   //     from.add(Calendar.DATE, -1);
    ...
    @Test
    public void testStateDatatype() throws ServiceException {
        DataStream streamObject = (DataStream)service.loadObject("mycustomkey","zustandalias");
        State state = new State(4, new Date());
        streamObject.saveData(state);
    }
